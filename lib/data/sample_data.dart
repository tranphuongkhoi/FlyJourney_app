...
//   // Generate mock data matching API response format
//   static Map<String, dynamic> generateOneWaySearchResponse(String departure, String arrival, String date) {
//     return {
//       "data": {
...
//           "infants": 0
//         },
//         "search_results": _generateFlightList(departure, arrival, date),
//         "sort_by": "price",
//         "sort_order": "asc",
//         "total_count": 10,
//         "total_pages": 1
...
//   static Map<String, dynamic> generateRoundtripSearchResponse(String departure, String arrival, String departureDate, String returnDate) {
//     return {
//       "data": {
//         "arrival_airport": arrival,
//         "departure_airport": departure,
...
//         "search_results": {
//           "outbound_flights": _generateFlightList(departure, arrival, departureDate),
//           "inbound_flights": _generateFlightList(arrival, departure, returnDate)
//         },
//         "sort_by": "price",
//         "sort_order": "asc"
//       },
...
//   static List<Map<String, dynamic>> _generateFlightList(String departure, String arrival, String date) {
//     // Helper function to get full airport name
//     String getAirportName(String code) {
//       switch (code) {
//         case "HAN": return "Sân Bay Nội Bài";
//         case "SGN": return "Sân Bay Tân Sơn Nhất";
//         case "DAD": return "Sân Bay Đà Nẵng";
//         case "PQC": return "Sân Bay Phú Quốc";
//         default: return "Sân Bay $code";
//       }
//     }

//     // For roundtrip return flights (arrival code passed as departure for return flights)
//     if (departure == "SGN" && arrival == "HAN") {
//       return [
//         {
//           "flight_id": 64,
//           "flight_class_id": 66,
...
//           "departure_airport": getAirportName(departure),
//           "arrival_airport": getAirportName(arrival),
...
//     // Default outbound flights (HAN -> SGN)
//     return [
//       {
//         "flight_id": 68,
//         "flight_class_id": 70,
...
//     // Convert new format to old Flight model for backward compatibility
//     final flights = <Flight>[];
//     final mockData = _generateFlightList(departure.code, arrival.code, date.toString());
    
//     for (var flightData in mockData) {
//       flights.add(Flight(
//         flightNumber: flightData['flight_number'],
//         airline: flightData['airline_name'],
//         airlineLogo: flightData['logo_url'],
//         departure: departure,
//         arrival: arrival,
//         departureTime: DateTime.parse(flightData['departure_time']),
//         arrivalTime: DateTime.parse(flightData['arrival_time']),
//         price: flightData['pricing']['grand_total'].toDouble(),
//         aircraft: 'Airbus A321',
//         availableSeats: flightData['total_seats'],
//         duration: _formatDuration(flightData['duration_minutes']),
//       ));
//     }
